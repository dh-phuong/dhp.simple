...
namespace hpsofts.StringHelper
{
    public sealed class StringHelper
    {
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public string DocSo(string numberStr, string moneyName, string decimalName, bool readNagative)
        {
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public string ReadNumber(string numberStr, string moneyName, string decimalName, bool readNagative)
        {
            bool isNegative = numberStr.IndexOf('-') == 0;
